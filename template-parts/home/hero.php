...
<section id="home" class="hero">
    ...
    <div class="hero__buttons">
        <a href="/new-patients/" class="hero__button hero__button--primary">
            New Patients
        </a>

        <a href="/existing-patients/" class="hero__button hero__button--secondary">
            Existing Patients
        </a>
    </div>
</div>
    ...
    <div class="hero__form-wrap">
        ...
        <?php
        get_template_part(
            'template-parts/home/appointment-form',
            null,
            [
