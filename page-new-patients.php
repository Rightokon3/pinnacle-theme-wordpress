/**
 * New Patients page — form submit success state and FAQ accordion.
 * Logic matches the reference "New Patient Intake Page" file.
 */
(function () {
        ...
        if (intakeForm) {
            intakeForm.addEventListener('submit', function (e) {
                ...
                this.innerHTML =
                    ...
                    '<p style="color:var(--muted); margin-top:10px; font-size:14.5px; max-width:440px; margin-left:auto; margin-right:auto;">Your intake form has been received. A member of our care team will reach out within one business day to match you with a provider and get your first visit scheduled.</p>' +
                    '</div>';
            });
        }
